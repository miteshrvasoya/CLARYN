...
import { Phone, Mail, MapPin, Share2, Globe, Rss, Link2 } from 'lucide-react';
  ...
  return (
    <footer className={styles.footer} role="contentinfo">
      ...
      <div className={styles.footerBrand}>
        <p className={styles.footerWordmark} aria-hidden>CLARYN</p>
        <p className={styles.footerTagline}>Water, understood.</p>
      </div>
